...
#sim.set_zflux(comps=["Comp8"], start_t=350, end_t=400, z_end=-0.65, adjust_x=False)
total_t = 1
time_step = 1e-6
sim.set_timing(total_t=total_t, time_step=time_step, intervals=100)
